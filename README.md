...
scripts/join_zoom.sh "https://app.zoom.us/wc/join/<id>?pwd=<encrypted_password>" "Mac VM 1"
...
#   preview / meeting window is separate: scripts/show_meeting_window.sh "<join_url>" "<topic>" "Mac VM 1"
